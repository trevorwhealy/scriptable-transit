...
const route_1_label = "Daly City";
const route_1_origin = "Daly City Bart";
const route_1_destination = "Powell Bart";

const route_2_label = "Powell";
const route_2_origin = "Powell Bart";
const route_2_destination = "Daly City Bart";
